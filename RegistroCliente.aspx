...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
  ...
  <script type="text/javascript">
      ...
      function validarClave() {
          ...
          // También actualiza la coincidencia si ya escribió confirmar
    ...
    <div class="contenedor-form">
        <div id="MenuCentral">
            ...
            <asp:TextBox ID="txtNombres" runat="server"
                CssClass="input" Placeholder="Nombres"></asp:TextBox>

            <asp:TextBox ID="txtApellidos" runat="server"
                CssClass="input" Placeholder="Apellidos"></asp:TextBox>
